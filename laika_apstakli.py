...
response = requests.get("https://api.wo-cloud.com/content/widget/?geoObjectKey=6508658&language=lv&region=LV&timeFormat=HH:mm&windUnit=mps&systemOfMeasurement=metric&temperatureUnit=celsius")
